package com.example.rbac_back.config.security.handler;
...
import com.example.rbac_back.utils.LoginResult;
import com.example.rbac_back.utils.ResultCode;
...
public class LoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request,
        ...
        //将token存入redis
        redisService.set(tokenKey, token, jwtUtils.getExpireTime() / 1000);
    }
}
